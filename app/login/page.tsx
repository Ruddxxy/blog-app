...
import { login, signup, signInWithOtp, verifyOtp, signInWithGoogle, signInWithGithub } from './actions';
        ...
        <div className="mt-8 flex flex-col gap-3 text-center text-xs font-bold uppercase tracking-widest">
          ...
          {mode === 'login' && (
            <>
              ...
              <button onClick={() => setMode('otp')} className="hover:underline text-gray-500">
