    ...
    <footer className="border-t border-black bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-black">
        ...
        <div className="p-8 flex flex-col justify-between h-full min-h-[200px]">
          <div>
            ...
            <p className="text-sm font-mono text-gray-500">
              Minimalist thoughts in a brutalist world.
            </p>
          </div>
          <div className="text-xs font-bold uppercase tracking-widest mt-8">
        ...
        <div className="p-8 flex flex-col gap-4">
          ...
          <Link href="/" className="text-lg font-bold hover:underline decoration-2 underline-offset-4 w-fit">
            Home
          </Link>
          <Link href="/about" className="text-lg font-bold hover:underline decoration-2 underline-offset-4 w-fit">
            About
          </Link>
        ...
        <div className="p-8 flex flex-col gap-4">
          ...
          <Link href="/login" className="text-lg font-bold hover:underline decoration-2 underline-offset-4 w-fit">
            Login
          </Link>
          <Link href="/dashboard" className="text-lg font-bold hover:underline decoration-2 underline-offset-4 w-fit">
            Dashboard
          </Link>
        </div>
